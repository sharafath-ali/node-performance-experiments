...
- _(Note: In containerized environments, running single-process pods/containers and letting Kubernetes scale the horizontal instances is generally preferred over doing internal Node.js clustering.)_
